			...
			<tbody>
                ...
                <tr>
                	...
                	<td class="text-center">
                		...
                		<cms:pages masterpage="coal.php" custom_field="tdate >= <cms:date return='first day of this month last year' format='Y-m-d' /> | tdate < <cms:date return='last year' format='Y-m-d' /> | coal_type='MLSW'">
                	...
                	<td class="text-center">
                		...
                		<cms:pages masterpage="coal.php" custom_field="tdate >= <cms:date 'first day of april last year' format='Y-m-d' /> |  tdate < <cms:date return='last year' format='Y-m-d' /> | coal_type='MLSW'" >
                ...
                <tr>
                	...
                	<td class="text-center">
                		...
                		<cms:pages masterpage="coal.php" custom_field="tdate >= <cms:date return='first day of this month last year' format='Y-m-d' /> | tdate < <cms:date return='last year' format='Y-m-d' /> | coal_type='MELG'">
                	...
                	<td class="text-center">
                		...
                		<cms:pages masterpage="coal.php" custom_field="tdate >= <cms:date 'first day of april last year' format='Y-m-d' /> |  tdate < <cms:date return='last year' format='Y-m-d' /> | coal_type='MELG'" >
