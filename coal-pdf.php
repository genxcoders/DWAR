...
<a href="javascript:coalPDF()" class="btn btn-warning gxcpl-fw-700"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF</a>
	...
	<cms:set area_count='0' scope='global' />
	<!-- Global Values -->
							...
							body: [
								...
								[	
									...
									},
									{
										...
										bold: true,
										fillColor: '#d9d9d9',
										text: '<cms:if ly_load_total eq "0">-<cms:else_if ly_load_total eq "0" /><cms:set difference_total="<cms:sub cy_load_total ly_load_total />" /><cms:set vari_total="<cms:div difference_total ly_load />" scope="global" /><cms:set variation_total= "<cms:mul vari_total '100' />" scope="global" /><cms:number_format variation_total decimal_precision="2" /></cms:if>'
									},
									{
