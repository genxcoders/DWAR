...
<cms:template title='Reason Import' order="6" parent='_blck_' executable="0" >
...
<div class="gxcpl-ptop-20"></div>
    ...
    <cms:if mystart >
        ...
        <cms:set my_template_name = "reason.php" />
         <cms:set my_page_title="<cms:show _col_1 />" />
        <cms:php>
            global $CTX, $FUNCS;
            $name = $FUNCS->get_clean_url( "<cms:show my_page_title /> <cms:show category />" );
        ...
        <cms:if my_page_id=''>
            <cms:db_persist
                _auto_title         = '0'
                _invalidate_cache   = '0'
                _masterpage         = 'reason.php'
                _mode               = 'create'

                k_page_title        = "<cms:show _col_1 /> <cms:show category />"
