...
<cms:template title='Import' order="2" parent='_coal_' executable="0" >
    ...
    <cms:if mystart >
        ...
        <div class="col-md-2 gxcpl-card text-center" style="width: 80%; height: auto !important; margin-left: 11%;">
            <div class="gxcpl-ptop-5"></div>
                Total data imported: <strong><cms:show k_total_records /></strong>.<br>
            <div class="gxcpl-ptop-5"></div>
        </div>
        <cms:set my_template_name = "coal.php" />
        <cms:set my_page_title="<cms:show _col_6 /> <cms:show _col_3 /> <cms:date return='-366 days' tdate />" />
        <cms:php>
            global $CTX, $FUNCS;
        ...
        <cms:pages masterpage='coal.php' page_name=my_page_name limit='1' show_future_entries='1'>
        ...
        <cms:if my_page_id=''>
            <cms:db_persist
                ...
                k_page_title        = "<cms:show _col_6 /> <cms:show _col_3 /> <cms:date return='-366 days' tdate />"
                k_page_name         = "<cms:random_name />"

                tdate               = "<cms:date return='-366 days' tdate format='Y/m/d' />"
