...
<cms:template title='Coal Import' clonable='1' parent='_coal_' >
...
<cms:embed 'header.html' />
    ...
    <cms:if mystart >
        ...
        >
            ...
            <cms:set my_page_title="<cms:date _col_1 format='Y-m-d' /> <cms:pages masterpage='loading-pt.php' page_title=_col_2 limit='1' ><cms:show k_page_title /></cms:pages> <cms:show _col_3 />" />
            <cms:php>
                global $CTX, $FUNCS;
            ...
            <tr>
                ...
                <cms:capture into='my_loading_point'>
                ...
                <cms:if my_page_id=''>
                    <cms:db_persist
                        ...
                        k_page_title      = "<cms:date _col_1 format='Y-m-d' /> <cms:pages masterpage='loading-pt.php' page_title=_col_2 limit='1' ><cms:show k_page_title /></cms:pages> <cms:show _col_3 />"
                        k_page_name       = "<cms:show k_page_title />"

                        tdate             = "<cms:date _col_1 format='Y-m-d' />"
                        loading_point     = "<cms:show my_loading_point />"
                        hlf_ful           = "<cms:show _col_3 />"
                    >
                        <cms:if k_error>
