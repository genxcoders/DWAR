			...
			<div class="col-md-12">
				<div class="gxcpl-card">
					...
					<div class="gxcpl-card-footer" style="line-height: 24px; text-align: left;">
						...
						<cms:set to_ta_count_pdf="<cms:show to_ta_count />" scope='global' />
						<cms:set to_la_count_pdf="<cms:show to_la_count />" scope='global' />
						<cms:set to_ta_loco_count_pdf="<cms:show to_ta_loco_count />" scope='global' />
						<cms:set to_la_loco_count_pdf="<cms:show to_la_loco_count />" scope='global' /> -->
						<!--  -->
						<!-- <cms:set to_ac_actual_count_pdf="<cms:pages masterpage='pointwise-interchange.php' custom_field="is_interchanged=1 | to_ho=0 | interchange=<cms:gpc 'interchange' method='get' /> | arrival_date=<cms:gpc 'arrival_date' method='get' />"><cms:each loco sep='+'><cms:if ((char_alpha ne 'D') || (char_alpha ne 'd') || (char_alpha ne '(D)' && (fir_dig eq '2' || fir_dig eq '3' || (three_number_fir_dig eq '2' || three_number_fir_dig eq '3'))) || (char_alpha ne '(d)'))><cms:show k_total_records /></cms:if></cms:each></cms:pages>" scope='global' /> -->
						<!--  -->

						
						<!-- <cms:pages masterpage='pointwise-interchange.php' custom_field="is_interchanged=1 | to_ho=0 | interchange=<cms:gpc 'interchange' method='get' /> | arrival_date=<cms:gpc 'arrival_date' method='get' />">
							<cms:ignore>
							<cms:each loco >
								each loco (<cms:show k_count />)<br>
								<cms:embed 'loco-conditions.html' />
								<cms:if fir_dig eq '1' || fir_dig eq '5' || fir_dig eq '7' || three_number_fir_dig eq '1' || three_number_fir_dig eq '5' || three_number_fir_dig eq '7'>
									<cms:if is_interchanged eq '1'>
										Interchanged (<cms:show k_count />)<br>
										
										<cms:incr my_to_dsl_actual_count '1' /><cms:show item />[<cms:show my_to_dsl_actual_count />]<br>
						...
						<cms:set to_ac_count_pdf="<cms:show to_ac_count />" scope='global' />
						<cms:set to_dsl_count_pdf="<cms:show to_dsl_count />" scope='global' /> -->
					</cms:ignore>
					...
					<div class="gxcpl-card-body tableFixHead <cms:if size>gxcpl-scroll</cms:if>">
						<table class="gxcpl-table rpttbl" id="ho">
							...
							<tbody>
								...
								<cms:pages masterpage='pointwise-interchange.php' custom_field="interchange=<cms:gpc 'interchange' method='get' /> | arrival_date=<cms:gpc 'arrival_date' method='get' /> | to_ho=1 | is_interchanged='1' | today_interchange='1' | departure_time='1988-01-01 00:00:00' " order='asc' orderby="departure_time">
								<cms:ignore>Setting Sign On time to calculate if the row is changing color</cms:ignore>
									<cms:embed 'overdue.html' />
							 	...
							 	<!-- For Interchanged with today's interchange & No Dep Time -->
								<cms:pages masterpage='pointwise-interchange.php' custom_field="interchange=<cms:gpc 'interchange' method='get' /> | arrival_date=<cms:gpc 'arrival_date' method='get' /> | to_ho=1 | is_interchanged='1' | today_interchange='1' | departure_time<>'1988-01-01 00:00:00' " order='asc' orderby="departure_time">
								<cms:ignore>Setting Sign On time to calculate if the row is changing color</cms:ignore>
									<cms:embed 'overdue.html' />
									<cms:set ho_no_dep_td_int ="<cms:show k_total_records />" scope='global' />
									<cms:embed 'ptwise-int-report-table-ho.html' />
							 	</cms:pages>
							 	<!-- For Interchanged with today's interchange & No Dep Time -->
								...
								<cms:ignore>Setting Sign On time to calculate if the row is changing color</cms:ignore>
							 	...
							 	<!-- For Interchanged with not today's interchange & No Dep Time -->
								<cms:pages masterpage='pointwise-interchange.php' custom_field="interchange=<cms:gpc 'interchange' method='get' /> | arrival_date=<cms:gpc 'arrival_date' method='get' /> | to_ho=1 | is_interchanged='1' | today_interchange<>'1' | departure_time<>'1988-01-01 00:00:00' " order='asc' orderby="departure_time">
								<cms:ignore>Setting Sign On time to calculate if the row is changing color</cms:ignore>
									<cms:embed 'overdue.html' />
									<cms:set ho_no_dep_int ="<cms:show k_total_records />" scope='global' />
									<cms:embed 'ptwise-int-report-table-ho.html' />
							 	</cms:pages>
							 	<!-- For Interchanged with not today's interchange & No Dep Time -->

							 	<!-- Not Interchange with today's interchange & dep time-->
								<cms:pages masterpage='pointwise-interchange.php' order='asc' orderby='departure_time' custom_field="is_interchanged<>1 | to_ho=1 | interchange=<cms:gpc 'interchange' method='get' /> | arrival_date=<cms:gpc 'arrival_date' method='get' /> | departure_time='1988-01-01 00:00:00' | today_interchange=1 " show_future_entries='1'>
									<cms:embed 'overdue.html' />	
								...
								<!-- Not Interchange with today's interchange & no dep time-->
								<cms:pages masterpage='pointwise-interchange.php' order='asc' orderby='departure_time' custom_field="is_interchanged<>1 | to_ho=1 | interchange=<cms:gpc 'interchange' method='get' /> | arrival_date=<cms:gpc 'arrival_date' method='get' /> | departure_time<>'1988-01-01 00:00:00' | today_interchange=1 " show_future_entries='1'>
									<cms:embed 'overdue.html' />	
									<cms:set ho_tdy_no_dep_int ="<cms:show k_total_records />" scope='global' />
									<cms:embed 'ptwise-int-report-table-ho.html' />
								</cms:pages>
								<!-- Not Interchange with today's interchange & no dep time-->

								<!-- NOT Interchanged with today's interchange but not eq arival date-->
								...
								<cms:ignore>Setting Sign On time to calculate if the row is changing color</cms:ignore>
							 	...
							 	<!-- NOT Interchanged with today's interchange but not eq arrival date-->

								<!-- NOT Interchanged with not today's interchange & ne arrival date but dep time -->
								<cms:pages masterpage='pointwise-interchange.php' order='asc' orderby='departure_time' custom_field="is_interchanged<>1 | to_ho=1 | interchange=<cms:gpc 'interchange' method='get' /> | arrival_date<><cms:date arrival_date /> | departure_time='1988-01-01 00:00:00' | today_interchange<>1 " show_future_entries='1'>
									<cms:embed 'overdue.html' />	
								...
								<!-- NOT Interchanged with not today's interchange but eq arrival date & no dep time -->
								<cms:pages masterpage='pointwise-interchange.php' order='asc' orderby='departure_time' custom_field="is_interchanged<>1 | to_ho=1 | interchange=<cms:gpc 'interchange' method='get' /> | arrival_date=<cms:gpc 'arrival_date' method='get' /> | departure_time<>'1988-01-01 00:00:00' | today_interchange<>1  " show_future_entries='1'>
									<cms:embed 'overdue.html' />	
									<cms:set ho_no_dep_nt_int ="<cms:show k_total_records />" scope='global' />
									<cms:embed 'ptwise-int-report-table-ho.html' />
								</cms:pages>
								<!-- NOT Interchanged with not today's interchange but eq arrival date & no dep time -->

								<!-- Carry forward -->
							 	<!-- NOT Interchanged & eq arrival date-->
							 	<cms:pages masterpage='pointwise-interchange.php' custom_field="interchange=<cms:gpc 'interchange' method='get' /> | to_ho=1 | is_interchanged<>'1' | arrival_date=<cms:gpc 'arrival_date' method='get' />" order='asc' orderby="departure_time">
								<cms:ignore>Setting Sign On time to calculate if the row is changing color</cms:ignore>
									<cms:embed 'overdue.html' />
									<cms:set ho_not_int ="<cms:show k_total_records />" scope='global' />
									<cms:embed 'ptwise-int-report-table-ho.html' />
							 	</cms:pages>
							 	<!-- NOT Interchanged & eq arrival date-->

							 	<!-- NOT Interchanged with not today's interchange & not eq arrival date-->
							 	<cms:pages masterpage='pointwise-interchange.php' custom_field="interchange=<cms:gpc 'interchange' method='get' /> | to_ho=1 | is_interchanged<>'1' | arrival_date!=<cms:gpc 'arrival_date' method='get' /> | today_interchange<>1 " order='asc' orderby="departure_time">
								<cms:ignore>Setting Sign On time to calculate if the row is changing color</cms:ignore>
									<cms:embed 'overdue.html' />
									<cms:set ho_no_dep_not_int ="<cms:show k_total_records />" scope='global' />
									<cms:embed 'ptwise-int-report-table-ho.html' />
							 	</cms:pages>
							 	<!-- NOT Interchanged with not today's interchange & not eq arrival date-->
							</tbody>
