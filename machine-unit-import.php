...
<div class="gxcpl-ptop-20"></div>
    ...
    <cms:if mystart >
        ...
        <cms:set my_template_name = "machine-units.php" />
         <cms:set my_page_title="<cms:show _col_1 /> <cms:show _col_2 />" />
        <cms:php>
            global $CTX, $FUNCS;
        ...
        <cms:capture into='mac'>  
            <cms:pages masterpage='machine-units.php' page_title=_col_2 limit='1' >
                <cms:show k_page_id />
            </cms:pages>
        </cms:capture > 
        <cms:if my_page_id=''>
            <cms:db_persist
                _auto_title         = '0'
                _invalidate_cache   = '0'
                _masterpage         = 'machine-units.php'
                _mode               = 'create'

                k_page_title        = "<cms:show _col_1 /> <cms:show _col_2 />"
                k_page_name         = "<cms:show k_page_title />"

                k_page_title        = _col_1
                machine             = "<cms:show mac />"
                >
                <cms:if k_error >
                    <div class="col-md-3">
